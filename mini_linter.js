...
console.log("Number of unnecessary words: " + (storyWords.length - betterWords.length));
console.log(`Overused words: Really: ${reallyCount}. Very: ${veryCount}. Basically: ${basicallyCount}.`);
